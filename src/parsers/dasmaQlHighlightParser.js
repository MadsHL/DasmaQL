...
function peg$parse(input, options) {
  ...
  var peg$f0 = function() { return options.highlight("comment", text()); };
  var peg$f1 = function() { return options.highlight("string", text()); };
  var peg$f2 = function() { return options.highlight("field", text()); };
  var peg$f3 = function() { return options.highlight("function", text()); };
  var peg$f4 = function() { return options.highlight("misc", text()); };
  var peg$f5 = function() {
