const dasmaQlParserTestCases = [
        ...
        {
            expression: '(field1 = "value1" OR field2 = "value2" OR field3 = "value3") AND field4 = "value4" AND field5 = "value5" AND field6 = "value6" order by field1 desc',
            expected: {
                "expression": {
                    "operator": {
                        "type": "and",
        ...
        {
            expression: 'field1 not in (1,2) and field2 not like "text" and field3 not between (1,22.2) # this is a comment so this should be ignored -> field1 = "value1" OR field2 = "value2"',
            expected: {
                "expression": {
                    "operator": {
                        "type": "and",
...
module.exports = {dasmaQlParserTestCases: dasmaQlParserTestCases};