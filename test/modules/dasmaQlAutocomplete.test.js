...
const {dasmaQlAutocomplete} = require("../../src");

describe('DasmaQlAutocomplete', function() {
    const sampleQlString = "field1 = \"value1\" OR field2 != 2024-12-24 AND (anotherField in (\"value3.1\", \"value3.2\") OR field4 = value4() AND field5 between (1,9)) ORDER BY field1, field2 asc, field3 desc -- This is a comment";
    let autocomplete;
    ...
    describe('#getSuggestions()', function() {
        ...
        it('should return an array of suggestions for parameter', function() {
            ...
            assert.deepStrictEqual(suggestions,  ['field1:value1', "field1:value2", "field1:value3"]);
        });
    });
