...
const {dasmaQlSyntax} = require("../../src/");
...
describe('DasmaQlSyntax', function () {
    it('should parse a valid query string with options', () => {
        ...
        const {model, highlight, validation} = dasmaQlSyntax(options).parse(qlString);
    ...
    it('should parse a valid query string without options', () => {
        ...
        const {model, highlight, validation} = dasmaQlSyntax().parse(qlString);
